import {Item} from "/JS_HW/asset/todo/item.js";
...
export class List
{
	...
	{
		const index = this.items.indexOf(item);
		this.items[index].editModeSwitcher();
		this.items[index].saveTitle();
		this.renderItems();
